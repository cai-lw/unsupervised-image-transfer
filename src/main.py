...
flags.DEFINE_integer("src_size", 32, "The size of the src images [32]")
flags.DEFINE_integer("dst_size", 28, "The size of the dst images to produce [28]")
flags.DEFINE_integer("src_c_dim", 3, "Dimension of src image color. [3]")
flags.DEFINE_integer("dst_c_dim", 1, "Dimension of dst image color. [1]")
